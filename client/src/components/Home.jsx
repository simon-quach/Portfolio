...
const Home = () => {
  return (
    <div
      id="home"
      className="w-full h-[calc(100vh-72px)] relative flex flex-col justify-center items-center gap-[48px] cursor-default text-center"
    >
      <motion.div
      ...
      >
        ...
        <img
          src={ProfilePicture}
          alt="profile-picture"
          className="w-[12rem] rounded-[6rem] relative"
        />
      </motion.div>
      <motion.div
